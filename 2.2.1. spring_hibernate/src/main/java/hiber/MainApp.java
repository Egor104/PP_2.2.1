...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Car car1 = new Car("Honda", 12);
      Car car2 = new Car("Toyota", 34);
      Car car3 = new Car("Lexus", 56);
      Car car4 = new Car("Ferrari", 78);
      ...
      System.out.println(userService.getUserByCar("Honda", 12).toString());
